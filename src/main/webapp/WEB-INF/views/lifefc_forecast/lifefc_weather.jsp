...
.nav-tabs-custom .tab_content ul {
	width: 100%;
	margin: 0px;
	padding: 0px;
}
.nav-tabs-custom .tab_content ul li {
	padding: 5px;
	list-style: none;
}
.tab_content {
...
<div class="wrapper">
	...
	<ul class="sidebar-menu" data-widget="tree">
		...
		<ul class="treeview-menu">
			<li><a href="/bigdata/byelement_analyze"><i class="fa fa-circle-o"></i> 요소별 분석</a></li>
			<li><a href="/bigdata/statistical_analysis"><i class="fa fa-circle-o"></i> 통계분석 결과</a></li>
		</ul>
		</li>
	...
	<div class="content-wrapper">
		...
		<ol class="breadcrumb">
			...
			<li><a href="#">예보</a></li>
			<li class="active">생활기상지수</li>
		</ol>
		</section>
		<!-- Main content -->
<!-- 		<div class="lifefcDataCheck"><iframe src="/lifefc/LifefcDataCheck.do?jisuname=식중독"></iframe></div> -->
<c:if test="${ sessionScope.login.getU_EMAIL()== null }" >
<c:set var="loginEmailId" value="fc_default_user" />
</c:if>
<c:if test="${ sessionScope.login.getU_EMAIL()!= null }" >
<c:set var="loginEmailId" value="${sessionScope.login.getU_EMAIL()}" />
</c:if>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#tab_1" data-toggle="tab"><b>지역별 생활지수</b></a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane active" id="tab_1">
							<!-- 		               <div id="div_lifefcsearch"></div> -->
							<iframe src="/lifefc/LocalJisuSelView.do?email=${loginEmailId}" id="menu1" onload="iframeAutoResize(this);">							</iframe>
						</div>
						<!-- /.tab-pane -->
					</div>
					<!-- /.tab-content -->
			...
			<div class="col-md-6">
				...
				<div class="nav-tabs-custom">
					<ul class="tabs">
						<li class="active" rel="tab1"><b>식중독 지수</b></li>
						<li rel="tab2"><b>자외선 지수</b></li>
					</ul>
					<div class="tab_container">
						<div class="tab_content" id="tab1">
						
							<iframe src="/lifefc/FsnJisuSelView.do?email=${loginEmailId}" onload="iframeAutoResize(this);">
							</iframe>
						</div>
						<!-- 		              /.tab-pane -->
						<div class="tab_content" id="tab2">
							<iframe src="/lifefc/UtryJisuSelView.do?email=${loginEmailId}" onload="iframeAutoResize(this);">
							</iframe>
						</div>
						<!-- 		              /.tab-pane -->
					</div>
		...
		<!-- /.content -->
		<input type="hidden" id="tempsession" readonly="readonly" value="${sessionScope.emailStr}"/>
	</div>
...
// 					alert('pc 접속'); 
		...
		function iframeAutoResize(h){ if(h == null){ return false; } (h).height = "0px"; var iframeHeight= (h).contentWindow.document.body.scrollHeight; (h).height=iframeHeight + 15; }
	</script>
<!-- Bootstrap 3.3.7 -->
